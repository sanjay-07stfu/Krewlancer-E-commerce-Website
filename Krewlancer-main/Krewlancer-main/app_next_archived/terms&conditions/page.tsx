...
const termsSections = [
  {
    ...
    content:
      "Your privacy is extremely important to us. We are committed to protecting the personal information you share and ensuring your experience on www.krewlancer.com is secure, respectful, and transparent. This policy explains how we collect, use, disclose, and safeguard your personal data.",
  },
  {
    title: "2. Products",
    content:
  ...
  },
  {
    ...
    content:
      "All images, designs, logos, and content on this website are the property of krewlancer and may not be copied, reproduced, or used without prior permission.",
  },
  {
        ...
        <div className="max-w-4xl mx-auto">
          <section className="text-center mb-16">
            ...
            <p className="text-gray-500 text-sm tracking-widest max-w-2xl mx-auto leading-relaxed">
              Welcome to krewlancer. By accessing or purchasing from our website, you agree to the following terms and conditions.
            </p>    
          </section>

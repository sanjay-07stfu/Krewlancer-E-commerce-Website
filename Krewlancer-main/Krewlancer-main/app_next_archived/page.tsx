        ...
        <section className="px-6 md:px-16 pt-4 pb-16 md:pt-8 md:pb-20 bg-[#030303]">
          <div className="max-w-5xl mx-auto text-center">
            <p className="text-[8vw] sm:text-5xl md:text-6xl leading-[1.35] md:leading-[1.3] font-serif text-[#d8d8d6]">
              krewlancer is premium menswear designed for the modern man who values style, comfort, and craftsmanship with innovative tailoring to deliver clothing that makes a statement—confident, stylish, and refined.
            </p>s

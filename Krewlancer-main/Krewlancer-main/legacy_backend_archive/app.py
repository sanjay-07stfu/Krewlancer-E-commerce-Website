...
def get_homepage_config():
    ...
    default_config = {
        ...
        "manifesto_text": "We believe in the quiet power of silence. In a world of noise, krewlancer is the absence of it. We strip away the unnecessary to reveal the essential structure of the human form. This is not just clothing; this is architecture for the soul.",

    ...
    if (!customer) {
        return (
            <div className="bg-[#030303] text-[#e8e8e3] min-h-screen px-4 sm:px-6 md:px-8 py-10 md:py-16">
                <Link to="/admin/customers" className="uppercase tracking-widest text-xs text-gray-500 flex items-center gap-2 mb-12">
    ...
    return (
        <div className="bg-[#030303] text-[#e8e8e3] min-h-screen px-4 sm:px-6 md:px-8 py-10 md:py-16">
            <div className="max-w-300 mx-auto">
                <Link to="/admin/customers" className="uppercase tracking-widest text-xs text-gray-500 flex items-center gap-2 mb-12 hover:text-white transition-colors w-fit">
                    <ArrowLeft size={14} /> Back to Customers
                </Link>
                                        ...
                                        {customer.orders.map((order: any, i: number) => (
                                            <tr key={order.id} className={`border-b border-white/5 hover:bg-white/4 transition-colors ${i % 2 === 0 ? "bg-[#050505]" : ""}`}>
                                                <td className="px-6 py-4">
                                                    <Link to={`/admin/orders/${order.id}`} className="text-white hover:underline uppercase tracking-widest text-[10px]">
                                                        {order.id}
                                                    </Link>
                                                </td>

              ...
              <div className="space-y-12">
                ...
                <div className="border border-white/10 p-4">
                  <label className="flex items-start gap-3 text-xs text-gray-400 leading-relaxed">
                    ...
                    />
                    <span>
                      I agree to the <Link to="/terms&conditions" target="_blank" className="text-[#C8A45D] hover:text-white underline underline-offset-4">Terms & Conditions</Link> and authorize order placement.
                    </span>
                  </label>
                  {checkoutTermsError && (

...
export default function AccountPage() {
  ...
  useEffect(() => {
    ...
    const alreadySeen = localStorage.getItem(greetingSeenKey)

    if (!alreadySeen) {
      setShowHelloGreeting(true)
      localStorage.setItem(greetingSeenKey, "1")
      return
    }
          ...
          <div className="p-5 md:p-10 max-w-4xl">
            ...
            <div className="mb-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/account/orders" className="text-[10px] uppercase tracking-widest text-gray-600 hover:text-white transition-colors">
                  View All →
                </Link>
              </div>
              ...
              {userOrders.length > 0 ? (
                ...
                <div className="border border-white/10 p-8 text-center">
                  ...
                  <Link to="/shop" className="text-xs uppercase tracking-widest text-gray-400 hover:text-white transition-colors">
                    Start Shopping →
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              <div className="border border-white/10 p-8 text-center mt-8">
                 ...
                 <Link to="/admin" className="inline-block border border-amber-400/30 px-8 py-3 text-[10px] uppercase tracking-[0.2em] text-amber-400 hover:bg-amber-400 hover:text-black transition-all">
